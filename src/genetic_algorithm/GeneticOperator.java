...
public class GeneticOperator {
	...
	/**
	 * This method implements Mutation strategy for Transtion Matrix of Markov Models 
	 * @param parent_1
	 * @param parent_2
	...
	public Vector<double[][]> mutationTransitionMatrix(double[][] parent_1, double[][] parent_2) {
		...
		// Verifies that the random number is less than the number selected in the row
	...
	/**
	 * This method implements Crossover strategy for Transtion Matrix of Markov Models
	 * @param parent_1
	 * @param parent_2
	 * @return sons in an vector
	 */
	...
	public Vector<double[][]> crossoverSigma(double[] parent_1, double[] parent_2) {
		...
		// For the first child if the event of the first position is greater than the value 
		...
		// For the second child if the event of the first position is greater than the value 
		// of the second position it exchanges them
